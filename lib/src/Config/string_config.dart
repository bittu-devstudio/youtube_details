...
///
/// The final request URL for a video will look like:
/// ```
/// https://www.youtube.com/oembed?url=https://www.youtube.com/watch?v=VIDEO_ID&format=json
/// ```
/// The `format=json` parameter is automatically included by the API function.
const String videoDetailsUrl =
    'https://www.youtube.com/oembed?url=https://www.youtube.com/watch?v=';

/// Base URL for YouTube search queries.
///
/// Example usage:
/// ```
/// https://www.youtube.com/results?search_query=CHANNEL_OR_KEYWORD
/// ```
const String searchUrl = 'https://www.youtube.com/results?search_query=';
